              ...
              <li key={task.id}>
                <div
                  className={`flex items-center font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 ${
                    task.id === selectedTask.id ? "dark:bg-zinc-400 dark:text-black font-bold bg-gray-700 text-white" : " dark:bg-zinc-700 dark:hover:bg-zinc-600 bg-gray-50 hover:bg-gray-300 "
