...
const defaultTasks: Task[] = [
	...
	{id: 6, name: 'Limpiar la casa', status: false},
	{id: 7, name: 'Ir al supermercado', status: true},
	{id: 8, name: 'Llamar al dentista', status: false},
	{id: 9, name: 'Estudiar para el examen', status: false},
];
